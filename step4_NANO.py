...
# with command line options: step4 --filein file:mini_test.root --fileout file:nano_test.root --mc --eventcontent NANOEDMAODSIM --datatier NANOAODSIM --conditions 94X_mc2017_realistic_v10 --step NANO --nThreads 2 --era Run2_2017,run2_nanoAOD_94XMiniAODv2 -n -1
