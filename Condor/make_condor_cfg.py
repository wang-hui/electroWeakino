...
folder_name = "testforhui"
folder_path = "/eos/uscms/store/user/sthayil/rpvhiggsinos/gensim/"
file_list = glob.glob(folder_path + folder_name + '/GENSIM_2017_NanoAODcompatible_oneproc*.root')
